...
local tog = true
local move = false
local Player = game:GetService("Players").N37GS
local Character = Player.Character
local mov = {};
local mov2 = {};

Character.Stinger77.Handle.Mesh:Remove()
Character.LocalPlayer.Character:WaitForChild("Racing Helmet Flames").Handle.Mesh:Remove()
